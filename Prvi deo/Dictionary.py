...
studenti = {
    ...
    "Prezime": "Markovic", 
    "JMBG": 202020202,
    "Mesto rodjenja": "Gornji Milanovac",
    "Adresa" : "Beograd, Mike Alasa 2"
}



print(studenti['JMBG'])
#recnici nemaju hjerarhijsku strukturu
#nema sortiranja
#metode za recnike
# keys, values, methods
...
print(string[1])
broj = len(string)
print("Broj je jedank " + str(broj))
prazanRecnik = {}

for i in range(0, broj):
    prazanRecnik[i] = string[i]


print(prazanRecnik.values())
print("===================================")
print(prazanRecnik)


print("============krecemo==================")
#brojanje slova u recniku

brojac = 0
prazanRecnik2 = {}
for i in string:
    prazanRecnik2.setdefault(i, 0)
    prazanRecnik2[i] = prazanRecnik2[i] +1

pprint.pprint(prazanRecnik2)
